...
const CHAPTERS = [
  ...
  },
  {
    ...
    bonusItem:{emoji:'🌟', name:'美善的恩賜', desc:'「各樣美善的恩賜和各樣全備的賞賜都是從上頭來的，從眾光之父那裏降下來的；在他並沒有改變，也沒有轉動的影兒。」', slot:'bg'}
  },
  {
  ...
  },
  {
    ...
    bonusItem:{emoji:'🌧️', name:'等雨的農夫', desc:'「弟兄們哪，你們要忍耐，直到主來。看哪，農夫忍耐等候地裏寶貴的出產，直到得了秋雨春雨。」', slot:'bg'}
  }
];
