...
const CHAPTERS = [
  ...
  },
  {
    ...
    guide:{
      intro:'希伯來書寫給一群信了主，卻信得很累，開始想往後退的人。第6章先講了全卷最讓人心驚的一段話：那些已經蒙光照，嘗過天恩，後來卻公然離棄的人，光景有多嚴重。但作者話沒停在這裡——他緊接著對讀信的人說「我深信你們強過這些」，最後把整章收在一個畫面上：神親自起了誓，要托住每一個逃向他的人，這指望像一個錨，又堅固又牢靠。',
      outline:[
      ...
      focus:'今日情境題聚焦在 9-11節與 18-19節——當你害怕自己是不是已經犯太多，回不去了，這段話把焦點從「我會不會失去救恩」轉到「神已經起了誓，他不會放手」。'
    },
    ...
    choices:[
      ...
      {k:'C', text:'我會把這份害怕老實帶到神面前，問他：我還能回來嗎？'},
      {k:'D', text:'老實說，我真的很怕，我不確定自己到底還算不算得救。'}
    ],
    responses:{
      A:'想用更多的努力把自己拉回安全地帶，這份拚命背後，是真的在乎——而「在乎」正是這段經文要你聽見的關鍵。6:4-6 講的那種「不能重新懊悔」，是一個人公然背棄，轉身把基督重釘十字架那樣決絕剛硬的狀態；一個還會擔心，還想靠近的人，恰恰不是那種人。你不需要用業績去贖回神的心，因為 6:17-18 說，神是親自起誓要托住你的。今天可以少做一件「證明自己」的事，多留五分鐘，只是安靜地待在他面前，什麼都不必交。',
      B:'把可怕的念頭壓下去，是一種本能的自保，不用為這個自責——有些恐懼太重，能先活下來已經不容易。只是壓住的東西不會消失，它會在半夜回來。這段經文其實很想對你說一句話：你會這麼怕，本身就說明你的心還在神這裡，還在乎他怎麼看你；真正「回不去」的人，是連怕都不會怕的。下次那個念頭又冒出來時，試著不要立刻關掉它，而是輕輕對神說一句：「這個我自己扛不動，先交給祢。」',
      C:'你願意把害怕直接端到神面前，開口問「我還能回來嗎」，這已經是一個很勇敢的動作了——而這個問題的答案，整段 6:18 早就寫好了：神為那些「逃往避難所」的人預備了確據。你問這句話的時候，其實就已經在往避難所跑了。回家的門從來不是你關上的，是他一直開著的。今天可以把那句問話完整地對神說出來，然後加一句：「我聽見祢說門還開著了。」',
      D:'謝謝你敢說出這句話，這比任何「我很好」都更靠近神。先放下一個重擔：這段經文不是要逼你「現在立刻確信自己得救」，也不是在對你下「再不悔改就來不及」的最後通牒——這些都不是它的意思。它真正在做的，是指著一件事實：神向承受應許的人「起誓為證」，他用自己的誓言作保，好叫逃向他的人「可以大得勉勵」。你不確定的時候，他是確定的；你抓不住的時候，是他抓住你。今天你不必逼自己相信「我一定得救」，只要做一件小事就好——對神說：「我不確定，但我來了。」來，就夠了。'
    },
    reflectionTitle:'靈魂的錨',
    reflection:'這章前半段的警告是真的，作者沒有軟化它。但他寫那段話的對象，是「親愛的弟兄們」，而且他緊接著說「我深信你們強過這些」（6:9）。然後他把整章收在一個畫面上：神因為沒有比自己更大的可以指著起誓，就指著自己起誓，要托住每一個逃向他的人。這份指望，像一個拋進深海，扣住磐石的錨——風浪再大，船不會漂走。\n\n你心裡有沒有一件事，讓你偷偷懷疑自己是不是已經被神放棄了？如果可以把那件事輕輕放到「神已經起誓」這個事實旁邊，你會發現它的份量變得不一樣。今天，你願不願意試著相信：抓住你的不是你的手，是他起了誓的手？把你最怕的那句話寫下來，然後在旁邊寫上：「但他起了誓。」',
  ...
  },
  {
    ...
    guide:{
      intro:'希伯來書第7章在講一位很特別的祭司——麥基洗德。他在創世記裡只出現一下子，沒有記載父母，沒有族譜，沒有生死的開始與結束，作者說他「與神的兒子相似」，用他來預表基督。重點是：舊約的祭司靠的是血統，一代一代換，因為人會死；但基督這位大祭司不靠血統，不靠律法，而是憑「無窮之生命的大能」，永遠活著，職任永不更換。所以他能把靠近神的人「拯救到底」，因為他長遠活著，一直在替他們祈求。',
      outline:[
        ...
        {nodes:'20-25節', text:'這位祭司永不換班——別的祭司會死，會換人，但耶穌是起誓立的，永遠常存，所以他能把靠近神的人拯救到底，因為他長遠活著，替他們祈求 ✦'},
        {nodes:'26-28節', text:'他正合我們所需——這位聖潔，無玷污，高過諸天的大祭司，只一次把自己獻上就成全了一切，是成全到永遠的'}
      ],
      focus:'今日情境題聚焦在 25節——撇開麥基洗德的譜系考據，鎖在一個很實在的安慰：此刻有一位永不下班，長遠活著的大祭司，正在替你祈求。'
    },
    verse:'「凡靠著他進到神面前的人，他都能拯救到底；因為他是長遠活著，替他們祈求。」',
    verseRef:'—— 希伯來書 7:25',
    scene:'這一章用了很多篇幅在論「等次」「血統」「律法」，讀起來像在上一堂神學課。但作者繞了一大圈，其實是要帶到一個很溫暖的結論：你有一位大祭司，他不像地上的祭司會老，會死，會換班，他永遠活著。而他活著在做甚麼？經文說，他「替他們祈求」。也就是說，此刻，當你在忙，在累，甚至忘了禱告的時候，有一位從不下班的，正在為你向神開口。',
    q:'「此刻有一位一直在為你禱告，從不下班的大祭司」——這句話，現在的你聽進去是甚麼感覺？',
    choices:[
      {k:'A', text:'有點被安慰到。我常覺得自己禱告斷斷續續，原來有人一直替我補上。'},
      {k:'B', text:'我想多懂一點——他「替我祈求」到底是甚麼意思？是真的在為具體的我說話嗎？'},
      {k:'C', text:'道理上知道，但感覺很遠。我很難真的相信「此刻」有誰在為我禱告。'},
      {k:'D', text:'老實說無感。我連自己都顧不好了，很難想像有誰會一直惦記著我。'}
    ],
    responses:{
      A:'被安慰到，是因為這句話正好接住了你心裡那個一直過不去的愧疚——「我禱告得太少，太斷續」。經文沒有要你先禱告得夠多才配被記得，它說的是：有一位「長遠活著」的，一直在替你開口，從沒停過。你的斷續，不會中斷他的祈求。今晚可以很輕鬆地對他說一句：「謝謝祢在我禱告不出來的時候，一直替我說話。」',
      B:'這個想懂的心很好，而且答案就藏在那幾個字裡——「替他們祈求」。不是泛泛地為全世界，是「他們」，是一個一個進到神面前的人，包括此刻在讀這段的你。他不是把你交給一份名單就走開，是長遠活著，親自為具體的你開口。這禮拜可以帶著一個問題去讀禱告：如果真有一位此刻正在為我祈求，他最可能在為我求的是哪一件事？把那件事，今晚也自己向神說一次。',
      C:'「道理上知道，但感覺很遠」——願意這樣說很誠實，而且這正是這章經文體貼的地方。它沒有叫你先「感覺到」才算數，它陳述的是一個事實：他「長遠活著，替他們祈求」，不管你此刻感覺得到感覺不到，他都在做這件事。感覺會起起伏伏，他的代求不會。今晚不用勉強自己生出感動，只要試著對他說一句：「我感覺不到，但如果祢真的在為我禱告，求祢讓我慢慢信得過。」',
      D:'謝謝你這麼老實，「我連自己都顧不好」這句話裡的累，是真的。我想先慢下來跟你說：這章經文最溫柔的地方，正是它沒有要求你先有力氣，先顧好自己，才輪得到被惦記。它說有一位「長遠活著」的，此刻就在替你祈求——在你顧不動自己，無力開口的時候，他替你撐著那個禱告。你不必先變好才被記得。今晚甚麼都不用做，只把這個累壞的自己擺在他面前，說一句：「我顧不了了，這個我，先交給祢。」'
    },
    reflectionTitle:'替我祈求',
    reflection:'希伯來書第7章繞著一個對比在走：地上的祭司「數目本來多，是因為有死阻隔，不能長久」（7:23），一代換一代；但基督這位大祭司「是永遠常存的，他祭司的職任就長久不更換」（7:24）。他不靠血統，不靠律法，而是「照無窮之生命的大能」作祭司（7:16）。所以全章的結論落在25節這句安慰上——「凡靠著他進到神面前的人，他都能拯救到底；因為他是長遠活著，替他們祈求」。重點不是麥基洗德的譜系，是你有一位永不換班，此刻仍在為你開口的大祭司。\n\n停一分鐘，想想此刻你心裡最放不下，最沒力氣自己禱告的那一件事。經文說，有一位「長遠活著」的，正在替你向神祈求那件事——不是等你禱告夠多才開始，是此刻就在進行。如果真有一位從不下班，一直在為你代求的，這對現在的你意味著甚麼？你願意把哪一件交給他，讓他替你也替你自己向神說一次？',
  ...
  },
  {
    ...
    guide:{
      ...
      outline:[
        ...
        {nodes:'8-9節', text:'神引耶利米書的話：日子將到，他要與以色列家另立新約，不像從前那約'},
        {nodes:'10-12節', text:'新約的內容——神要把律法寫在人心上，作他們的神，並且不再記念他們的罪愆 ✦'},
        {nodes:'13節', text:'神既說「新約」，就表明他主動向人重新立約的恩典臨到了'}
      ],
      focus:'今日情境題聚焦在 10 和 12節——神說他要把律法寫進你心裡，還說他「不再記念」你的罪愆；對一個總是記得自己每一次失敗的人，神選擇遺忘，是什麼感覺？'
    },
    verse:'「我要將我的律法放在他們裡面，寫在他們心上；我要作他們的神；他們要作我的子民。」',
    verseRef:'—— 希伯來書 8:10',
    scene:'夜深了，你又想起那件事。可能是很久以前說過的一句傷人的話，做過一個讓自己羞愧的決定，或某段你寧願沒發生過的關係。別人早就忘了，神也說他「不再記念」，可是你自己記得清清楚楚，每次安靜下來它就浮上來。你信神已經赦免你了——道理你懂——但「被神選擇性地遺忘」這件事，你好像一直沒辦法真的領受。',
    q:'神說他「不再記念」你的罪愆，可是你自己一直記得。面對這個落差，你今晚會怎麼面對自己？',
    choices:[
      {k:'A', text:'試著相信神的版本：他說忘了，那就是真的忘了，我不必比神更記得。'},
      {k:'B', text:'把那件一直放不下的事，具體地對神說一次，問他「這個，祢真的不記得了嗎」。'},
      {k:'C', text:'老實說我做不到「原諒自己」，神忘了是神的事，我還是過不去。'},
      {k:'D', text:'我連神到底有沒有真的赦免我都不太確定，更別說感覺到了。'}
    ],
    responses:{
      A:'你願意相信神的版本，而不是自己的記憶，這是很大的一步。神說「不再記念」，用的是一個主動的，選擇性的動作——不是他失憶，是他決定不再翻舊帳。你比神更記得自己的罪，有時候不是謙卑，是不肯接受自己已經被放下了。今晚可以試著對神說一句：「祢說祢忘了，那我也學著，不再每天替祢記著。」',
      B:'把那件具體的事說出口，比泛泛地說「求祢赦免我所有的罪」更需要勇氣，因為你得直視它。但神的「不再記念」從來不是對著一團模糊的罪，是對著你心裡那件最清楚，最不敢提的事說的。你今晚不用解決它，只要把它的名字輕輕講給神聽，然後問他：「這一件，祢真的不記得了嗎？」聽聽看心裡的回答。',
      ...
      D:'連有沒有被赦免都不確定，這種懸著的感覺其實很多人都有，只是不敢講。神在這章主動說話——是他開口立約，他說要寫在你心上，他說不再記念，整件事的主動權都在他那邊，不在你夠不夠相信。你今晚不用先擠出確據才能來到他面前。可以就帶著這份不確定問他：「祢說的這個約，也算我一份嗎？」把問題交出去，是禱告的開始。'
    },
    reflectionTitle:'祂選擇遺忘',
    reflection:'希伯來書 8 章引用了耶利米書裡神的應許：他要與人另立新約，「我要將我的律法放在他們裡面，寫在他們心上」（v.10），並且「不再記念他們的罪愆」（v.12）。這不是人努力修來的關係，是神主動開口，主動立約，主動選擇遺忘。律法從冰冷的石版，搬進了有溫度的人心；罪愆從一筆筆的記帳，變成神親口說的「我不記得了」。\n\n安靜一分鐘，想一件你一直替神記著，神卻說他早已放下的事。如果此刻神就坐在你對面，溫柔地說「那件事，我真的不記得了」，你會有什麼反應——是鬆一口氣，是不敢相信，還是眼眶忽然熱了？把那句最真實的反應，寫下來或在心裡對他說一次。',
