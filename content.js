...
const CHAPTERS = [
  ...
  // ── 哥林多前書 5 ──
  {
    ...
    verse:'「你們既是無酵的麵，應當把舊酵除盡，好使你們成為新團；因為我們逾越節的羔羊基督，已經被殺獻祭了。」',
    verseRef:'—— 哥林多前書 5:7',
    ...
    responses:{
      ...
      D:'願意認真想一想，就已經是開始了。今天，給自己五分鐘的安靜，不用急著找答案，就讓這個問題在心裡停留一下。'
    },
    reflectionTitle:'除盡舊酵',
    reflection:'保羅說「你們既是無酵的麵，應當把舊酵除盡」——這句話的邏輯很特別：不是「你們要努力成為無酵的麵」，而是「你們已經是無酵的麵了，現在活出你們本來的樣子」。\n\n你生命裡有沒有一個「舊酵」——一個習慣、一段關係、一個模式——你知道它不屬於你現在的身份，但你還沒有認真處理它？今天，你願不願意帶著那件事禱告，就說：「神，我知道這個需要處理，我需要祢的幫助」？',
    baseItem:{emoji:'🍞',name:'無酵的新餅',desc:'「所以，我們守這節不可用舊酵，也不可用惡毒、邪惡的酵，只用誠實真正的無酵餅。」',slot:'hand'},
    bonusItem:{emoji:'🐑',name:'逾越節的羔羊',desc:'「你們既是無酵的麵，應當把舊酵除盡，好使你們成為新團；因為我們逾越節的羔羊基督，已經被殺獻祭了。」',slot:'bg'}
  },
  ...
  // ── 哥林多前書 6 ──
  {
    ...
    bonusItem:{emoji:'💎',name:'重價的印記',desc:'「因為你們是重價買來的，所以要在你們的身子上榮耀神。」',slot:'hat'}
  },
