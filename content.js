...
const CHAPTERS = [
  ...
  },
  {
    ...
    responses:{
      ...
      C:'會先讓自己等一下再決定，是一件值得留著的習慣——不是每個人在飢餓、疲憊或委屈的當下，都還有力氣按暫停鍵。這一章沒有替以掃找藉口，也沒有說他罪有應得，只是老實記下那一刻發生了什麼。今天可以做的，是把這個習慣講給一個你信得過的人聽：我通常會等一下，說說你是怎麼養成的。',
  ...
  },
  {
    ...
    q:'以撒不是打不過——他的僕人、牲畜比對方多得多，卻兩次都選擇讓井、換地方，而不是留下來爭到底。直到第三口井沒有人再爭，他說「耶和華現在給我們寬闊之地」——把寬闊算在神身上的，是以撒自己。你有沒有過一段路，是走過去之後才發現，那個能喘氣的地方不是你爭來的？',
    choices:[
      {k:'A', text:'有，遇到這種事我通常就直接換地方重新開始，不太會留下來吵'},
      {k:'B', text:'說不生氣是騙人的，每次心血被人一句話拿走，我都氣到手在抖，只是沒表現出來'},
      {k:'C', text:'道理我都懂，但要我笑著讓開、看自己做的東西變成別人的，我真的做不到'},
      {k:'D', text:'我通常會據理力爭，覺得是我先做的、先花的力氣，憑什麼要我讓'}
    ],
    responses:{
      A:'經文沒有寫以撒讓井時心裡在想什麼，只記下動作——他讓，他走，他再挖一口；而到了第三口井的那一夜，是神先對他說「不要懼怕！因為我與你同在」。也許你也是這樣，不是沒有感覺，只是選擇不留下來吵。今天不用做什麼，只需要在心裡記下一句：這次，我又換了地方，而不是留下來吵。',
  ...
  },
  {
    ...
    baseItem:{emoji:'📜', name:'苦情的名', desc:'「利亞懷孕生子，就給他起名叫呂便，因而說：『耶和華看見我的苦情，如今我的丈夫必愛我。』」', slot:'hand'},
