...
const CHAPTERS = [
  ...
  },
  {
    ...
    q:'神帶他們走的不是近路，是繞遠的路，理由是「恐怕百姓遇見打仗後悔，就回埃及去」——他們自己還沒開口，神已經先看見那個可能。你有沒有過類似的處境：不是眼前這條路比較難，而是有人（或你自己）覺得你還沖不上去，所以先繞了一段路？',
    choices:[
  ...
  },
  {
    ...
    guide:{
      ...
      hard:[
        ...
        '14:4、14:8、14:17 三次提到「耶和華使法老的心剛硬」。這幾節歷來有不同的理解，讀到這裡卡住很正常，可以先把它當作經文的敘述放著，順著故事往下讀。',
  ...
  },
  {
    ...
    baseItem:{emoji:'🪨', name:'先站在那裡的神', desc:'「我必在何烈的磐石那裡，站在你面前。」', slot:'hat'},
  ...
  },
  {
    ...
    baseItem:{emoji:'😊', name:'便甚歡喜', desc:'「葉忒羅因耶和華待以色列的一切好處，就是拯救他們脫離埃及人的手，便甚歡喜。」', slot:'hat'},
  ...
  },
  {
    ...
    bonusItem:{emoji:'🌅', name:'滿了的年日', desc:'「你境內必沒有墜胎的，不生產的。我要使你滿了你年日的數目。」', slot:'body'}
  },
  {
