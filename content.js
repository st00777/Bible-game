...
const VERSION_NOTES = [
  '📖 「前往閱讀」旁新增「我已經讀過這章了」——紙本、其他 App 都算，同樣 +15 XP',
  '⏰ 完成靈修後問一句「明天大概什麼時候？」——只是跟自己約一下，不推播，⋯ 選單可關',
  '🤖 AI 回應看得見你身上的裝備經文，合適時會引一句',
  '🔥 改為累積靈修天數（中斷不歸零）；「稀有裝備」改名「默想裝備」',
  '✨ 新約之旅・終點：一年走完整本新約的紀念畫面（8/28 起顯示一次）',
  '📜 創世記 18–24 章內容上線（9/14–9/19，9/18 創22+23 合併日）'
];
