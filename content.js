...
const VERSION_NOTES = [
  '🎯 焦點模式：按「開始靈修」後畫面只留經文→情境→默想，「← 返回」回主畫面',
  '📅 日曆預設收起，主畫面一行「補讀或看其他日期」點開即展開',
  '🔥 右上角改為當日出席燈：今天完成任一章就亮，數字是累積靈修天數',
  '✨ 完成靈修的一瞬間：出席燈亮起＋今日裝備＋「📖 這卷書 收集 n/N」',
  '🧭 難的章節導讀多一段「這章讀者常卡在哪」，導讀底部可「先認識這卷書」',
  '📚 書卷背景全開：使徒行傳起 23 卷＋創世記的作者／時間／主題／結構＋人物冊'
];
