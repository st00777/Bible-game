...
const CHAPTERS = [
  ...
  },
  {
    ...
    bonusItem:{emoji:'🌀', name:'被指給看的異象', desc:'「拿著七碗的七位天使中，有一位前來對我說：「你到這裡來，我將坐在眾水上的大淫婦所要受的刑罰指給你看。地上的君王與她行淫，住在地上的人喝醉了她淫亂的酒。」」', slot:'bg'}
  },
  {
  ...
  },
  {
    ...
    guide:{
      ...
      outline:[
        ...
        {nodes:'5-8節', text:'坐寶座的說：看哪，我將一切都更新了！生命泉的水要白白賜給口渴的人；但膽怯的與不信的與行可憎之事的，他們的份是在火湖裡。'},
