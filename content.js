...
const CHAPTERS = [
  ...
  },
  {
    ...
    baseItem:{emoji:'🔏', name:'額上的印記', desc:'「並且吩咐牠們說，不可傷害地上的草和各樣青物，並一切樹木，惟獨要傷害額上沒有神印記的人。」', slot:'hat'},
    bonusItem:{emoji:'🎺', name:'第五位天使的號', desc:'「第五位天使吹號，我就看見一個星從天落到地上，有無底坑的鑰匙賜給它。」', slot:'hand'}
  },
  {
