...
const CHAPTERS = [
  ...
  },
  {
    ...
    guide:{
      ...
      outline:[
        ...
        {nodes:'18-27節', text:'約翰提醒有敵基督者出來迷惑人，但你們從那聖者受了恩膏，凡事都有真理教訓你們。'}
      ],
  ...
  },
  {
    ...
    guide:{
      intro:'這一章是整卷書的高峰，約翰講了一句大家都聽過的話：神就是愛。他說我們能愛，是因為神先愛了我們；而在成熟的愛裡面，是沒有懼怕的，因為愛把懼怕除去了。約翰想帶我們看見：跟神的關係如果一直卡在害怕裡，那還不是他所說的那份完全的愛。',
      outline:[
  ...
  },
  {
    ...
    guide:{
      ...
      outline:[
        ...
        {nodes:'6-12節', text:'神為祂兒子作見證；人有了神的兒子就有生命，沒有神的兒子就沒有生命。'},
        {nodes:'13節', text:'我將這些話寫給你們，要叫你們知道自己有永生。 ✦'},
        {nodes:'14-21節', text:'我們若照祂的旨意求什麼，祂就聽我們，這是我們向祂所存坦然無懼的心。'}
      ],
  ...
  },
  {
    ...
    baseItem:{emoji:'🕊️', name:'真理與愛心', desc:'「恩惠、憐憫、平安從父神和他兒子耶穌基督在真理和愛心上必常與我們同在！」', slot:'bg'},
  ...
  },
  {
    ...
    guide:{
      ...
      outline:[
        ...
        {nodes:'13-14節', text:'約翰還有許多話，但盼望快快見面，當面談。'}
      ],
  ...
  },
  {
    ...
    baseItem:{emoji:'🕊️', name:'多多加給的平安', desc:'「願憐恤、平安、慈愛多多地加給你們。」', slot:'bg'},
    bonusItem:{emoji:'👑', name:'保守你不失腳', desc:'「那能保守你們不失腳、叫你們無瑕無疵、歡歡喜喜站在他榮耀之前的我們的救主—獨一的神，願榮耀、威嚴、能力、權柄，因我們的主耶穌基督歸與他，從萬古以前並現今，直到永永遠遠。阿們！」', slot:'hat'}
  }
];
