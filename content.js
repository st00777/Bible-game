...
const CHAPTERS = [
  ...
  },
  {
    ...
    responses:{
      ...
      B:'把孤單收好再出門，是很多大人的日常。你收得起來，代表你撐了很久。今天不用急著改變什麼，只要讓一件事被記住：夜深那個時段的你，神也看見。睡前可以只說一句：神啊，這個時間的我，交給祢。',
  ...
  },
  {
    ...
    responses:{
      ...
      C:'慢慢放下、但不完全自由——這已經是很誠實的位置了。巴別塔的故事沒有責備人想被記住，它只是讓塔停在半空，然後把鏡頭轉向一份家譜：在那裡，被記住不需要自己蓋塔。今天可以為「已經不用蓋塔的那部分自己」謝謝祂，也為還在蓋的那部分，求一點鬆手的勇氣。',
