...
const CHAPTERS = [
  ...
  // ── 提摩太後書 1 ──
  {
    ...
    readTime:4,
    guide:{
      intro:'這是保羅在獄中，寫給屬靈兒子提摩太的最後一封信的開頭。保羅快走到生命盡頭，提摩太還年輕、還在恐懼裡。保羅沒有先講大道理，而是提起一件溫暖的事——提摩太裡面那份信，是外祖母羅以、母親友尼基一代一代傳下來的。然後他輕輕地說：不要膽怯，因為你不是孤單一個人在信。',
      outline:[
    ...
    verseRef:'—— 提摩太後書 1:12',
    scene:'保羅這封信是在監牢裡寫的，他大概知道自己快走到盡頭了。收信的提摩太還年輕，正在恐懼和退縮裡。保羅沒有逼他堅強，反而提起一件很溫柔的事：你裡面那份信，是外祖母羅以、母親友尼基傳給你的，你不是孤單一個人在信。然後他說：我也在受苦，也會被人看不起，但我不羞愧，因為我知道我所信的是誰。',
    ...
    reflection:'保羅在獄中提醒提摩太：你心裡那份信，是先在外祖母羅以、母親友尼基心裡的。原來信心不是憑空長出來的，是被人一代一代傳下來、活給你看的。在你最害怕、最想退縮的時候，那份從別人手裡接過來的信，會悄悄扶住你。\n\n回頭看，你的信是從誰那裡接過來的？有沒有一個人，曾經活出一種讓你想跟著信下去的樣子？如果你想得到，他叫什麼名字？',
    baseItem:{emoji:'🔥',name:'剛強的心',desc:'「因為神賜給我們，不是膽怯的心，乃是剛強、仁愛、謹守的心。」',slot:'hat'},
    bonusItem:{emoji:'🕯️',name:'無偽之信',desc:'「這信是先在你外祖母羅以和你母親友尼基心裡的，我深信也在你的心裡。」',slot:'bg'}
  },
  // ── 提摩太後書 2 ──
  {
    ...
    verseRef:'—— 提摩太後書 2:13',
    scene:'保羅在牢裡寫信，知道自己快走到盡頭了。他沒有交代財產，他交代的是「把你從我這裡聽見的，再傳給下一個忠心的人」。他用精兵、比武的選手、勞力的農夫三個畫面，講同一件事：忠心是要忍耐的。然後他輕輕補上一句：就算你軟弱、失信了，神也不會因此離開你——因為祂不會背叛祂自己。',
