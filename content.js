...
const CHAPTERS = [
  ...
  },
  {
    ...
    responses:{
      ...
      B:'有些事真的就壞掉了，沒有翻轉。這一章也沒有假裝那不痛——它說神心中憂傷。你為那件事難過，不是軟弱，是跟神同一個方向。今天可以為那個已經過去的人或事，對祂說一句遲到的話：那件事，我還是會難過。',
      ...
      D:'說不出口沒關係。這一章讀起來本來就重，讀完不想說話是正常的。這一章的話很重，中間卻有一句是安靜的：惟有挪亞在耶和華眼前蒙恩。那是在一切壞掉之後，經文安靜記下的一句。今天不用回答任何問題，讀到這裡就可以了。睡前只要一句：祢知道我現在說不出來。'
    },
    reflectionTitle:'惟有',
  ...
  },
  {
    ...
    responses:{
      ...
      C:'說出來怪怪的，但這一點也不怪。被關住的另一面就是被保護——經文把這兩件事寫成同一個動作：耶和華就把他關在方舟裡頭。你不需要為「鬆了一口氣」感到抱歉。今天可以誠實地跟祂說：謝謝祢，我現在還不想出去。',
      D:'還在裡面、說不清楚——那就先不用說清楚。這一章給的也不是解釋，是一個很短的句子：耶和華就把他關在方舟裡頭。你不必知道這件事對你的意思是什麼，也不必現在判斷它是保護還是困住。今天只做一件事：在裡面的時候，跟祂說一句話。什麼都可以。'
    },
  ...
  },
  {
    ...
    guide:{
      ...
      outline:[
        ...
        {nodes:'20-22節', text:'挪亞為耶和華築壇獻燔祭。耶和華心裡說：不再因人的緣故咒詛地，也不再按著才行的滅各種活物；地還存留的時候，稼穡、寒暑、冬夏、晝夜就永不停息。'}
      ],
    ...
    responses:{
      A:'記得很清楚，是因為那段日子真的很長。這一章也不假裝等待很短——數字一個接一個，鴿子放出去又回來。但經文把「神記念挪亞」放在最前面，在水退之前、在鴿子回來之前。經文沒有說你那段日子裡發生了什麼，它說的是神是怎樣的神：記念，是祂先動的。今天可以回頭，為那段日子對祂說一句：原來祢那時候也在。',
      ...
      D:'還沒過去——那我們就不假裝它過去了。這一章最長的部分就是等待，而且是不知道還要等多久的等待。經文在那段等待的最前面放了一句話：神記念挪亞。它不是說「很快就好了」，它是說：在水還沒退的時候，神先動了。今天不用撐、不用走出來，只要在還沒過去的地方說一句：我還在等。求祢記念我。'
    },
    reflectionTitle:'記念',
  ...
  },
  {
    ...
    responses:{
      ...
      B:'覺得欠、想還——很多人在恩典面前的第一個反應就是這個。可是這一章的約有一個細節：記念的是神（「我便記念」），看見虹的也是神（「我看見」）。祂沒有把「記得這個約」的責任放在人身上。你不用急著還。今天先練習一次不還：謝謝祢。就這樣，不加「我會更……」。',
      ...
      D:'不太相信——這很誠實，而且說不定是因為你被辜負過。這一章不要求你先相信；它只是記下一個事實：有一個約，記號是神放的，記念的是神，對象包括「一切有血肉之物」，約本身沒有附條件。信不信得過，可以慢慢來。今天只把不相信說出來：我不太信這種關係存在。如果祢就是這樣，讓我看見一次。'
    },
    reflectionTitle:'記號',
    ...
    bonusItem:{emoji:'☁️', name:'我便記念', desc:'「我便記念我與你們和各樣有血肉的活物所立的約，水就再不氾濫、毀壞一切有血肉的物了。」', slot:'bg'}
  },
  {
    ...
    responses:{
      ...
      C:'偶爾冒出來，是正常的；那個念頭不會一次就消失。這一章沒有什麼安慰的話，它只是很安靜地把名字寫完——幾十個名字，一個都沒跳過。它給的不是一句鼓勵，是一個事實：被記下來的人，多半沒做過什麼值得寫進故事的事。下次那個念頭冒出來的時候，可以只做一件小事：把自己的名字，在神面前說一遍。',
      D:'不確定想不想被記住——有時候被記住也是一種壓力，或是以前被記住的方式並不好。這份名單裡的人幾乎沒有評語，只是被寫下來：叫什麼，從誰而出，住在哪裡。沒有分數。你可以先不決定想不想，今天只隨便挑名單裡三個名字讀一遍，注意那裡沒有評語，只有名字。然後如果願意，跟祂說：我還不確定。但祢可以先知道我在這裡。'
    },
    reflectionTitle:'有名字',
