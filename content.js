...
const VERSION_NOTES = [
  '📚 主畫面新分頁「書卷與成就」：書架、每卷徽章、已解鎖成就都在這裡看（原成就視窗退役）',
  '🏷️ 新裝備部位「稱號」：累計走完的書卷數到里程碑就解鎖，在衣櫃換上',
  '👗 領獎畫面可直接「試穿」：衣櫃疊在領獎畫面上開，關掉回到領獎畫面',
  '🎭 創世記 2／4／6／8／11 章情境題調整：四個選項涵蓋更多立場，過得還不錯的人也有一格',
  '👤 訪客模式也能解鎖讀經／默想／時段／補讀類成就'
];
