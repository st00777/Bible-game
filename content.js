...
const VERSION_NOTES = [
  ...
  '📚 新增書卷進度頁面',
  '📖 新增靈修日記（含AI回應）',
  '🤖 AI靈修回應（Gemini 2.5 Flash）',
  '📊 新增Google Analytics數據追蹤',
  '🗓️ 新增五月份靈修內容（哥林多前書、哥林多後書）',
  '🐛 修正章節名稱顯示錯誤',
  '🐛 修正導讀文字截斷問題'
];
...
const CHAPTERS = [
  ...
  // ── 加拉太書 1 ──
  {
    ...
    baseItem:{emoji:'📜',name:'啟示的福音',desc:'「我素來所傳的福音不是出於人的意思。」',slot:'hand'},
  ...
  // ── 加拉太書 3 ──
  {
    ...
    baseItem:{emoji:'🛡️',name:'贖回的咒詛',desc:'「基督既為我們受了咒詛，就贖出我們脫離律法的咒詛。」',slot:'hand'},
