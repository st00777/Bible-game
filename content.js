...
// 2026.08.31／2026.09.01／2026.09.05 為純後台或修復版（SUPPRESS_VERSION_POPUP=true），notes 維持 08.30 批；
// 下次彈公告的進版必須重寫本陣列。
const VERSION_NOTES = [
...
const CHARACTERS = {
  ...
  //   image 選填：該時期的人物立繪／頭像。有圖才顯示。desc 只寫經文明說的事，句尾 // 出處。
  ...
  peter: {
    ...
    periods: {
      gentile_mission: { book: 'ACT', title: '打開外邦門的使徒',
        desc: '在約帕禱告時三次看見異象，神吩咐他不可再稱神所潔淨的為俗物；他因此進了外邦人哥尼流的家，見證「神不偏待人」。// 徒 10:9-16、10:34',
        unlock: 10 },
      shepherd: { book: 'PE1', title: '同作長老、受苦的見證人',
        desc: '自稱是耶穌基督的使徒，也是基督受苦的見證人、同作長老的；寫信勸勉分散各省、正經歷患難的信徒，效法基督的腳蹤行。// 彼前 1:1、5:1',
        unlock: 'PE1_1' },
    },
  },
  titus: {
    ...
    periods: {
      corinth: { book: 'COR2', title: '報信與收捐的同工',
        desc: '保羅差派去哥林多教會的同工。在馬其頓見到他，聽見哥林多教會讀信後悔改的好消息，安慰了保羅；又受託去經手為耶路撒冷聖徒收的捐項。// 林後 7:5-7、8:6',
        unlock: 'COR2_2' },
      crete: { book: 'TIT', title: '在克里特整頓教會',
        desc: '保羅照着與提多共信之道稱他為「真兒子」，留他在克里特，要他將那沒有辦完的事都辦整齊，又照保羅所吩咐的在各城設立長老。// 多 1:4-5',
        unlock: 'TIT1' },
    },
  },
  priscilla_aquila: {
    ...
    periods: {
      rome: { book: 'ROM', title: '冒死相救的同工',
        desc: '保羅在羅馬書問安名單裡特別記念的一對同工，稱他們「也為我的命將自己的頸項置之度外」；他們家中還有教會聚會。// 羅 16:3-5',
        unlock: 'ROM16' },
    },
  },
  paul: {
    ...
    periods: {
      ...
      early: { book: 'GAL', title: '為純正福音辯護',
        desc: '從前在猶太教中極力逼迫殘害神的教會；神將他兒子啟示在他心裡後，沒有與屬血氣的人商量，也沒有上耶路撒冷，惟獨往阿拉伯去，後又回到大馬士革。// 加 1:13、1:16-17',
        unlock: 'GAL1' },
  ...
  timothy: {
    ...
    periods: {
      ...
      companion: { book: 'TH1', title: '受差堅固教會',
        desc: '保羅在不能親自前去帖撒羅尼迦時，差提摩太去堅固、勸慰他們的信心；提摩太回來報告他們仍站立得穩、常常記念保羅，使保羅大得安慰。// 帖前 3:1-2、3:6',
        unlock: 'TH1_3' },
    },
  },
  epaphroditus: {
    ...
    periods: {
      messenger: { book: 'PHP', title: '腓立比差來的使者',
        desc: '腓立比教會差來供給保羅需用的使者，為做工的緣故幾乎至死、不顧性命；保羅囑咐腓立比教會要在主裡歡歡樂樂地接待他，並尊重這樣的人。// 腓 2:25-30',
        unlock: 'PHP2' },
    },
  },
  philemon: {
    ...
    periods: {
      host: { book: 'PHM', title: '接納歸回的僕人',
        desc: '保羅稱他為親愛的同工，他的愛心使眾聖徒的心從他得着暢快；保羅寫信求他接納逃走後信主的僕人阿尼西謀，不再是奴僕，乃是親愛的兄弟。// 門 1:1-2、1:7、1:16',
        unlock: 'PHM1' },
    },
  },
  onesimus: {
    ...
    periods: {
      returning: { book: 'PHM', title: '在監裡所生的兒子',
        desc: '腓利門的僕人，保羅說他從前於腓利門沒有益處，但如今於保羅和腓利門都有益處；保羅稱他是自己在捆鎖中所生的兒子，差他帶着這封信回到腓利門那裡。// 門 1:10-11',
        unlock: 'PHM1' },
    },
  },
  melchizedek: {
    ...
    periods: {
      encounter: { book: 'HEB', title: '撒冷王與大祭司',
        desc: '撒冷王，又是至高神的祭司；亞伯拉罕得勝回來時他出來迎接、祝福他，亞伯拉罕獻上十分之一；經文記他無族譜、無生之始無命之終。// 來 7:1-3',
        unlock: 'HEB7' },
    },
  },
  james: {
    ...
    periods: {
      writer: { book: 'JAS', title: '神和主耶穌基督的僕人',
        desc: '自稱是神和主耶穌基督僕人的雅各，寫信勸勉散住十二支派的信徒在試煉中站穩、活出信心；傳統認為是耶路撒冷教會的雅各。// 雅 1:1',
        unlock: 'JAS1' },
    },
  },
  jude: {
    ...
    periods: {
      writer: { book: 'JUD', title: '雅各的弟兄',
        desc: '自稱是耶穌基督的僕人、雅各的弟兄；寫信給蒙召、在父神裡蒙愛的人，提醒他們為真道竭力爭辯，防備混進教會的假師傅。// 猶 1:1、1:3-4',
        unlock: 'JUD1' },
    },
  },
  john: {
    ...
    periods: {
      elder: { book: 'JN1', title: '見證生命之道的人',
        desc: '在信的開頭自稱曾親眼看過、親手摸過那從起初就有的生命之道，把這見證傳下來，是要人的喜樂可以滿足。// 約一 1:1-4',
        unlock: 'JN1_1' },
      patmos: { book: 'REV', title: '拔摩海島時期',
        desc: '因為神的道，並為給耶穌作的見證，在那名叫拔摩的海島上看見復活的主，嚇得仆倒在地像死了一樣，主伸出右手按着他，對他說不要懼怕。// 啟 1:9、1:17',
        unlock: 'REV1' },
    },
  },
  gaius: {
    ...
    periods: {
      hospitality: { book: 'JN3', title: '忠心接待客旅',
        desc: '凡向作客旅之弟兄所行的都是忠心的，接待他們就是與他們一同為真理做工。// 約三 1:1、1:5-8',
        unlock: 'JN3_1' },
    },
  },
  diotrephes: {
    ...
    periods: {
      pride: { book: 'JN3', title: '好為首的人',
        desc: '在教會中好為首，不接待作長老的一行人；自己不接待弟兄，有人願意接待他也禁止，還把接待的人趕出教會。// 約三 1:9-10',
        unlock: 'JN3_1' },
    },
  },
  ...
  noah: {
    ...
    periods: {
      ...
      covenant: {
        book: 'GEN',
        title: '與萬物立約',
        desc: '神賜福給挪亞和他的兒子，吩咐他們「生養眾多，遍滿了地」；又與他們立約：「凡有血肉的，不再被洪水滅絕，也不再有洪水毀壞地了。」', // 創 9:1、9:9、9:11
  ...
  abraham: {
    ...
    periods: {
      ...
      call: {
        book: 'GEN',
        title: '蒙召離開本地',
        desc: '耶和華對亞伯蘭說：「你要離開本地、本族、父家，往我所要指示你的地去。」亞伯蘭就照著耶和華的吩咐去了，出哈蘭的時候年七十五歲。', // 創 12:1、12:4
      ...
      covenant: {
        book: 'GEN',
        title: '星空立約',
        desc: '耶和華領亞伯蘭走到外邊觀看滿天星宿，說：「你的後裔將要如此。」亞伯蘭信耶和華，耶和華就以此為他的義。', // 創 15:5、15:6
      ...
      offering: {
        book: 'GEN',
        title: '神必自己預備',
        desc: '神吩咐亞伯拉罕獻上他所愛的兒子以撒為燔祭；以撒問燔祭的羊羔在哪裡，亞伯拉罕說：「我兒，神必自己預備作燔祭的羊羔。」後來亞伯拉罕舉目觀看，有一隻公羊兩角扣在稠密的小樹中，就取來獻為燔祭，代替他的兒子。', // 創 22:2、22:8、22:13
  ...
  sarah: {
    ...
    periods: {
      ...
      promise: {
        book: 'GEN',
        title: '帳棚門口的應許',
        desc: '撒拉在帳棚門口聽見有人說她必生一個兒子，就心裡暗笑，說：「我既已衰敗，我主也老邁，豈能有這喜事呢？」耶和華卻問亞伯拉罕：「耶和華豈有難成的事嗎？」', // 創 18:10、18:12、18:14
      ...
      burial: {
        book: 'GEN',
        title: '麥比拉的安葬',
        desc: '撒拉享壽一百二十七歲，死在迦南地的基列‧亞巴，就是希伯崙；亞伯拉罕為她哀慟哭號，向赫人買下麥比拉田間的洞，把撒拉埋葬在那裡。', // 創 23:1、23:2、23:19
  ...
  jacob: {
    ...
    periods: {
      ...
      blessing: {
        book: 'GEN',
        title: '祝福與異夢',
        desc: '雅各聽從母親利百加的主意，假扮兄長以掃，從父親以撒那裡得了長子的祝福，以掃因此怨恨雅各；雅各逃往哈蘭，途中夢見梯子直通天，醒來說：「耶和華真在這裡，我竟不知道！」', // 創 27:23-29、27:41-43、28:12、28:16
      ...
      wrestle: {
        book: 'GEN',
        title: '雅博渡口摔跤',
        desc: '雅各在雅博渡口獨自一人，有一個人來和他摔跤，直到黎明；那人為他改名：「你的名不要再叫雅各，要叫以色列；因為你與神與人較力，都得了勝。」他就給那地方起名毗努伊勒。', // 創 32:24、32:28、32:30
      ...
      egypt: {
        book: 'GEN',
        title: '下埃及見約瑟',
        desc: '神對雅各說：「你下埃及去不要害怕，因為我必使你在那裡成為大族。」雅各就帶全家下埃及，與約瑟相見，伏在他頸項上哭了許久；以色列說：「我既得見你的面，知道你還在，就是死我也甘心。」', // 創 46:3、46:29、46:30
  ...
  judah: {
    ...
    periods: {
      ...
      blessing: {
        book: 'GEN',
        title: '權杖不離猶大',
        desc: '雅各為猶大祝福：「猶大啊，你弟兄們必讚美你；你手必掐住仇敵的頸項；你父親的兒子們必向你下拜。」又說：「圭必不離猶大，杖必不離他兩腳之間，直等細羅來到，萬民都必歸順。」', // 創 49:8、49:10
  ...
  joseph: {
    ...
    periods: {
      ...
      slave: {
        book: 'GEN',
        title: '下監仍蒙恩',
        desc: '約瑟被賣到埃及，在護衛長波提乏家中，「耶和華與他同在，他就百事順利」，蒙派管理家務；後來主母把話告訴主人，約瑟被下在監裡，「耶和華與約瑟同在，向他施恩，使他在司獄的眼前蒙恩」。', // 創 39:2、39:20-21
      ...
      ruler: {
        book: 'GEN',
        title: '解夢與治理埃及',
        desc: '約瑟為法老解夢，說：「這不在乎我，神必將平安的話回答法老。」法老說：「神既將這事都指示你，可見沒有人像你這樣有聰明有智慧」，就派他治理埃及全地，給他穿上細麻衣，戴上金鍊。', // 創 41:16、41:39、41:42
      ...
      reconcile: {
        book: 'GEN',
        title: '向兄弟表明身分',
        desc: '約瑟屏退左右，對兄長們說：「我是約瑟。我的父親還在嗎？」又說：「不要因為把我賣到這裡自憂自恨。這是神差我在你們以先來，為要保全生命。」他伏在便雅憫頸項上哭，又與眾弟兄親嘴痛哭。', // 創 45:3、45:4-5、45:14-15
