...
const CHAPTERS = [
  ...
  },
  {
    ...
    responses:{
      A:'記得很清楚，是因為那段日子真的很長。這一章也不假裝等待很短——數字一個接一個，鴿子放出去又回來。但經文把「神記念挪亞」放在最前面，在水退之前、在鴿子回來之前。經文沒有說你那段日子裡發生了什麼，它說的是神是怎樣的神：記念，是祂先動的。那段日子你記得很清楚；這一章則把「神記念」寫在日子開始之前。兩種記得，放在一起看，也許會有一點不一樣。',
  ...
  },
  {
    ...
    responses:{
      ...
      B:'覺得欠、想還——很多人在恩典面前的第一個反應就是這個。可是這一章的約有一個細節：記念的是神（「我便記念」），看見虹的也是神（「我看見」）。祂沒有把「記得這個約」的責任放在人身上。你不用急著還。記號掛在雲彩中，不是掛在你的帳上——虹不是欠條。如果「謝謝」後面那句「我會更……」一時拿不掉，也沒關係，它不影響約本身。',
  ...
  },
  {
    ...
    responses:{
      ...
      C:'偶爾冒出來，是正常的；那個念頭不會一次就消失。這一章沒有什麼安慰的話，它只是很安靜地把名字寫完——幾十個名字，一個都沒跳過。它給的不是一句鼓勵，是一個事實：被記下來的人，多半沒做過什麼值得寫進故事的事。下次那個念頭冒出來的時候，不用趕它走。這一章的邏輯不會因為它改變：被寫下來的人，沒有一個是因為夠大才被寫的。',
