...
const CHAPTERS = [
  ...
  },
  {
    ...
    choices:[
      {k:'A', text:'有，在職場——一樣努力，被稱讚的總是別人'},
      {k:'B', text:'有，在家裡——總覺得爸媽比較看重另一個孩子'},
      {k:'C', text:'有，甚至在教會——別人的服事被感謝，我的沒人記得'},
      {k:'D', text:'老實說，我連禱告都懷疑過：神是不是比較聽別人的'}
    ],
    responses:{
      A:'一樣的付出，不一樣的掌聲——這種酸不是小心眼，是人心真實的痛處。經文誠實地記下該隱的怒氣，也記下神沒有無視它，反而先來問他。下次那股酸湧上來的時候，先別急著壓下去，把它帶到神面前說：祢有看見我做的嗎？',
  ...
  },
  {
    ...
    choices:[
      {k:'A', text:'有。我現在就看著一件這樣的事，不知道還能怎麼辦'},
      {k:'B', text:'有過。後來它真的就那樣壞掉了，沒有轉圜'},
      {k:'C', text:'有，但我還在裡面撐著，不想承認它沒救了'},
      {k:'D', text:'我不確定，或者我現在說不出口'}
    ],
    responses:{
      A:'看著一件沒救的事，又什麼都做不了，那種無力很真實。創世記六章沒有先安慰，它先把規模說完：罪惡很大、終日都是惡、滿了強暴——神看的比你看到的還全。可是祂不是無動於衷：經文說祂心中憂傷。你看著的那件事，祂也在看。今天先不用想怎麼辦，只把它說給祂聽：這件事我看不下去了，祢也看見了嗎？',
  ...
  },
  {
    ...
    choices:[
      ...
      {k:'B', text:'有。後來有人想起我了，可是我還是會怕再被忘記'},
    ...
    responses:{
      ...
      B:'被想起了，卻還會怕——這很誠實，也很合理。這一章的結構很有意思：神記念挪亞是第一句，但之後還有一百五十天、四十天、七天、又七天。記念不是等待立刻結束，是在等待裡有人先動。你怕再被忘記的時候，可以把這句話拿出來，不是當保證，是當一個事實來讀：記念的主詞是神。今天就對祂說一次：我怕被忘記。求祢記念我。',
