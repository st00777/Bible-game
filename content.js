...
const CHAPTERS = [
  ...
  },
  {
    ...
    guide:{
      ...
      outline:[
        {nodes:'1-3節', text:'耶穌基督把將要成就的事指示約翰，念這預言又遵守的人有福了。'},
    ...
    verse:'「我一看見，就仆倒在他腳前，像死了一樣。他用右手按著我，說：「不要懼怕！我是首先的，我是末後的，」',
    verseRef:'—— 啟示錄 1:17',
    ...
    bonusItem:{emoji:'♾️', name:'昔在今在永在', desc:'「主神說：「我是阿拉法，我是俄梅戛，是昔在、今在、以後永在的全能者。」」', slot:'bg'}
  },
  {
    ...
    guide:{
      ...
      outline:[
        ...
        {nodes:'18-29節', text:'主稱讚推雅推喇末後所行的比起初更多；祂責備的是他們容讓那自稱先知的耶洗別引誘人，並說要叫耶洗別和跟從她行淫不悔改的人同受患難——對象是耶洗別和跟從她的人，不是整個教會。 ✦'}
      ],
    ...
    bonusItem:{emoji:'🍎', name:'生命樹的果子', desc:'「聖靈向眾教會所說的話，凡有耳的，就應當聽！得勝的，我必將神樂園中生命樹的果子賜給他吃。』」」', slot:'hand'}
  },
  {
  ...
  },
  {
    ...
    baseItem:{emoji:'🩸', name:'買贖的寶血', desc:'「他們唱新歌，說：你配拿書卷，配揭開七印；因為你曾被殺，用自己的血從各族、各方、各民、各國中買了人來，叫他們歸於神，」', slot:'bg'},
  ...
  },
  {
    ...
    guide:{
      ...
      outline:[
        ...
        {nodes:'12-14節', text:'第六印揭開，地大震動，日頭變黑，滿月變紅像血，天上的星辰墜落於地。'},
        {nodes:'15-17節', text:'地上的人都躲藏起來，躲避坐寶座者的面目和羔羊的忿怒，說誰能站得住呢。'}
      ],
      focus:'今天不談那句誰能站得住的問句，而是聚焦在祭壇下的呼求——原來在神面前，你是可以問還要多久的。'
    },
  ...
  },
  {
    ...
    bonusItem:{emoji:'🌴', name:'手中的棕樹枝', desc:'「此後，我觀看，見有許多的人，沒有人能數過來，是從各國、各族、各民、各方來的，站在寶座和羔羊面前，身穿白衣，手拿棕樹枝，」', slot:'hand'}
  }
];
