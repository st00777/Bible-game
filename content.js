  ...
  moses: {
    ...
    periods: {
      ...
      birth: {
        book: 'EXO',
        title: '從水裡拉出來的孩子',
        desc: '母親把他藏了三個月，後來不能再藏，就取了一個蒲草箱，把箱子擱在河邊的蘆荻中；法老的女兒收他作兒子，給他起名叫摩西，意思說：「因我把他從水裡拉出來。」長大後他殺了一個埃及人，逃往米甸地居住。',
...
const CHAPTERS = [
  ...
  },
  {
    ...
    responses:{
      ...
      C:'沒有特別的感覺，就不用硬找一個出來配合這一章。以色列人歎息了很多年，神才在23-25節一次被寫出來聽見，這中間漫長的沈默經文也照實記下，不是每天都要有感覺才算數。日子還算過得去，是值得記下的一件事，不是要否定掉的東西。今天不用做什麼，只在心裡或紙上記一句：這陣子過得還可以。',
  ...
  },
  {
    ...
    bonusItem:{emoji:'💍', name:'金器銀器', desc:'「要金器銀器和衣裳，好給你們的兒女穿戴。」', slot:'hand'}
  },
  {
    ...
    q:'摩西被叫去做那件事的時候，第一個念頭是「他們不會信我」，第二個是「我不會講話」。神問他的卻是他手上已經有什麼。你有沒有被人找去做一件事，第一個反應是「我沒有那個本事」？',
    choices:[
      {k:'A', text:'有，那種「憑什麼是我」的感覺我很熟，一被指到就先慌起來'},
      {k:'B', text:'我會先算算自己有什麼、缺什麼，缺的再想辦法補，情緒上倒還好'},
      {k:'C', text:'最近沒有人找我做什麼，日子照過，這章對我沒有特別的感覺'},
      {k:'D', text:'老實說我做不到，我很清楚自己沒有那個能力，通常就直接推掉了'}
    ],
    responses:{
      A:'那個「憑什麼是我」的慌，摩西也是一路慌到第四次推辭。有意思的是神沒有回他「你可以的」，也沒有說他想太多，而是問了另一件事：「你手裡是甚麼？」他答「是杖」——那是他四十年來天天拿著趕羊的一根木頭，不是新發的裝備。慌是真的，杖也是真的，兩件事可以同時在。今天做一件小事：把你手上已經有的東西具體寫下三樣，不寫你缺的，只寫已經在的。',
      B:'先算算有什麼、缺什麼，這是很實在的做法，這一章其實也是這樣走的——神沒有給摩西新的本事，是讓他看清楚已經拿在手上的那一根杖，後來那根杖被稱作「神的杖」，還是同一根。不過摩西最後一次開口已經不是在盤點了，是「你願意打發誰，就打發誰去吧」。今天可以問自己一個問題：你最近說「我還沒準備好」的那件事，是真的還缺條件，還是條件其實夠了、只是不想動？',
      C:'沒有人找你做什麼，那就沒有，不用為了配合這一章硬找一個責任出來。摩西被叫住以前，在米甸牧了四十年的羊；經文沒有寫這四十年他每天都在等一件大事，就是放羊、成家、過日子，而那根後來被稱作「神的杖」的東西，本來也只是牧羊人手上的一根木頭。今天不用找任務，只對自己說一句：我現在手上就這些，這樣也可以。',
      D:'「我做不到」不是你發明的說法。摩西一連講了四次：他們必不信我、我本是拙口笨舌的、主啊你願意打發誰就打發誰去吧。經文沒有把這些話刪掉，也沒有寫他後來突然變成能言的人；第14節神給的回應是「不是有你的哥哥利未人亞倫嗎？」，安排了另一個人跟他一起去，一個負責開口，一個負責帶話。你推掉的那件事，如果不是你一個人扛，會不會不一樣？這禮拜可以跟一個人說一句：這件事我一個人做不來，你願不願意跟我一起？'
    },
    ...
    bonusItem:{emoji:'🏔️', name:'神的山', desc:'「他就去，在神的山遇見摩西，和他親嘴。」', slot:'bg'}
  },
  {
    ...
    responses:{
      ...
      C:'自己扛下來，跟沒有感覺不一樣。經文裡的官長也不是悶著頭忍，他們先去哀求法老「為甚麼這樣待你的僕人」，把責任攤在法老面前；直到被法老罵「你們是懶惰的」，才知道是遭遇禍患了。經文沒有寫官長把這口氣憋著才是對的做法。今天可以問自己一句：這件事我一直沒跟人說，是因為不想麻煩人，還是覺得說了也沒用？',
  ...
  },
  {
    ...
    bonusItem:{emoji:'🗣️', name:'拙口笨舌', desc:'以色列人尚且不聽我的話，法老怎肯聽我這拙口笨舌的人呢？', slot:'hat'}
  },
  {
    ...
    q:'摩西、亞倫把該說的話說完了，該做的也做了，法老看過以後，心裡剛硬，不肯聽。你有沒有過那種話已經講出口、對方卻沒有任何反應的時候？那之後，你心裡是什麼感覺？',
    choices:[
  ...
  },
  {
    ...
    baseItem:{emoji:'🏡', name:'被分別的歌珊地', desc:'「當那日，我必分別我百姓所住的歌珊地，使那裡沒有成群的蒼蠅，好叫你知道我是天下的耶和華。」', slot:'bg'},
  ...
  },
  {
    ...
    responses:{
      ...
      C:'先觀察再決定，不是不信，是你習慣的方式。這一章裡神給的警告本身很具體——時間、後果、該怎麼因應都講清楚了，不是含糊的一句話；聽的人要不要當真，靠的是自己的判斷。今天可以練習一件事：挑一句你最近聽到、還在觀察的提醒，給自己一個具體的期限，到了那天就做決定，不要一直觀察下去。',
    ...
    bonusItem:{emoji:'🌱', name:'沒有冰雹的歌珊地', desc:'「惟獨以色列人所住的歌珊地沒有冰雹。」', slot:'bg'}
  },
  {
  ...
  },
  {
    ...
    responses:{
      ...
      C:'回頭想自己講得夠不夠清楚，這是一種認真，但也可能是一種太快讓自己下場的方式。這一章寫得很直接：摩西把話講完了，第9節接著說「法老必不聽你們」——經文把「沒有被聽進去」放在法老那一邊，沒有寫成摩西表達得不好。有些時候話沒有進去，真的不是講的人的問題。今天可以問自己一個問題：那件事我已經檢討過幾輪了，有沒有哪一輪其實是在替對方找理由？',
  ...
  },
  {
    ...
    guide:{
      ...
      focus:'今天聚焦在 11 節——那頓飯是腰帶束著、鞋穿著、杖拿在手上吃的；還有 42 節，事情都過去以後，經文回頭給這一夜起了名字：「這夜是耶和華的夜」。',
      hard:[
    ...
    responses:{
      A:'一直是這樣過的人，通常不是因為喜歡，是因為別無選擇的日子過久了。這一章寫他們束帶、穿鞋、拿杖地吃那頓飯，寫的全是動作，沒有寫他們心裡在想什麼，也沒有寫他們對那一夜有沒有把握——經文只記下他們照著行了。你已經有這個本事，那就別讓它只用在自己身上。這禮拜挑一個你知道正在等消息、心懸著的人，去跟他說一句具體的話：這幾天我都在，要跑腿、要接送、要有人陪著坐，開口就好。',
