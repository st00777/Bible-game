...
- 🎨 美術協調
- 📊 數據分析
- 📝 內容生產 ── **2026-08-24 起退役**（內容產線收斂進 Claude Code，見 docs/adr/0002-content-pipeline.md；視窗留檔不刪）
...
- **核心指標（「北極星」一詞退役）**：白話核心句「**本週有幾個人完成靈修並寫下默想**」＋兩守門（默想平均字數不掉、連續 4 週未出現的人名）；看月趨勢與人名清單，不當成長曲線讀。依據：`docs/research-north-star-metric.md`。
- **內容產線＝CC 一條龍**（2026-08-24 拍板，正本＝docs/adr/0002-content-pipeline.md）：CC 生成＋CUNP1 逐句驗經文→寫入＋dev 預覽＋PR；James 每週喊「出下週內容」後手機審稿；內容生產視窗退役（留檔不刪）。
- 未定案（主菜選擇、待辦殺併留、多視窗其餘收斂）詳見 ADR 0001「尚未定案」節，勿當已決。
