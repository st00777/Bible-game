...
> 最後更新：2026-08-28（協作模式收斂 ADR 0003）
...
**目前版本**：`2026.08.29`（日期版號制，2026-06-05 起；最後一個語意版號 v2.16 於 2026-06-14 上線。近期：8/28 PR ① 文案批＋自我約定＋AI 看裝備、8/29 PR ② 焦點模式＋完成短畫面＋出席燈、難章幫助、書卷背景全開 24 卷）
...
- [~] **PR ③** 書卷詳情頁第二期：③a 分頁「📖 今日靈修｜📚 書卷與成就」＋卷徽章＋裝備剪影（PR #48）、③b 稱號＝第五裝備部位、綁累計完走卷數 9 級（PR #49）── 兩者 2026-08-29 已合 dev、未上正式版。
  - ❌ ③c「每卷專屬稱號／每卷真稀有」── **2026-08-29 James 拍板砍**：與 ③b 累計階梯重複，玩家完走一卷會拿兩個稱號、語意打架；用現有機制即可。每卷的專屬感交給 ③d。
  - [ ] ③d 書卷完走儀式＋AI 旅程故事（functions 加 mode，deploy 需單獨確認）── PR ③ 僅剩此刀
