...
**目前版本**：`2026.08.30`（日期版號制，2026-06-05 起；最後一個語意版號 v2.16 於 2026-06-14 上線。近期：8/28 PR ①、8/29 PR ② 焦點模式＋出席燈、8/30 PR ③a/③b 書卷與成就分頁＋稱號＋創世記 2·4·6·8·11 情境題配額回補）
...
- [x] 遊戲說明頁（tut-overlay）更新（issue #53，方案 B：六步驟訂正文案＋「更多功能」兩層、成就入口改分頁）── 2026-08-30 施工，併入 2026.08.30、不彈公告
