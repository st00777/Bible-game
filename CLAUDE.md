...
**目前版本**：`2026.09.01`（品質整備：全專案檢視 A-D 批收官——5 個玩家可見 bug 修、安全加固（rules email_verified＋輸入上限、functions 輸入檢查＋SITES 表）、主邏輯抽出 app.js＋三 flag 退役，issues #75-#78、PR #79-#95；不彈公告。rules／functions／hosting:admin 已部署，兩站 17 步測玩全過；遺留 #93 #94。前版 2026.08.31 安全修正。日期版號制 2026-06-05 起，最後語意版號 v2.16（2026-06-14）。更早近況見 docs/history/）
