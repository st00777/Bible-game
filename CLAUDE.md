...
- [ ] **曠野呼聲 v2 多輪對話**（2026-05-01 規格已確認，待實作）── 詳見「曠野呼聲 v2 規格」段落。工程量約 2 個工作天
...
- ⏳ 待 v2 實作：messages 子集合 rule（role 由 rule 強制、only append、玩家只能寫 role:player、admin 只能寫 role:admin）
- ⏳ 待 v2 實作：create rule 加 `isAnonymous=true && wantReply=true` 衝突檢查
