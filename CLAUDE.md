...
- ※ 2026-09-19 止 content.js 已建到 11/04 EXO24（PR #131）；EXO25-40 待建（11/05-11/19，合併日 11/16 出36+37），下批最晚 10/26 上正式站、建議 10/12 那週開工；利未記 11/20 起。
...
- [ ] 等級階梯（只解周邊，解鎖項目與 ADR 0006 穿戴款式區分）＋「試煉」實驗（PR ③ 後）
- [ ] 時段成就統計 UI、介面美化 ──「併」入視覺改版（正本 `docs/animation-map.md`），不單獨做；獎勵雙軌另見 ADR 0006
