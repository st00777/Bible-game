...
const CHAPTERS = [
  ...
  },
  {
    ...
    responses:{
      A:'「要一直有表現，別人才會記得我」——照這句話活，人會很累，因為表現是會斷的。巴別塔造到一半就停了；而上一章那份名單裡被記下來的人，一件事蹟都沒有。在神這裡，被記得跟表現從來不掛鉤。今天可以試著問祂一句平常不敢問的：如果我甚麼都不做，祢還記得我嗎？',
  ...
  },
  {
    ...
    responses:{
      A:'不甘心是誠實的反應，不用假裝屬靈。注意這一章的時間差：神的應許是在羅得離開「以後」才來的；讓出去的當下，亞伯蘭手上甚麼保證都沒有，那幾天的空是真的空。今天可以把那件放不下的事講給祂聽，講完加一句：我想學舉目，不想一直盯著被拿走的那塊。',
      ...
      D:'「先搶先贏比較實際」——謝謝你說真話，多數時候世界確實是這樣運作的。這一章沒有罵這種活法，只是把另一種放在旁邊：有個人讓了，然後神叫他舉目。不用馬上改。今天可以只做一件事：想一個你最不想讓的場合，問問祂：在這裡讓，我是在怕失去甚麼？',
    },
    reflectionTitle:'讓一步',
    reflection:'亞伯蘭與羅得分手，是聖經裡最早的「分家」故事之一。經文很小心地記下順序：先是亞伯蘭放棄先選權，羅得拿走了看起來最好的；然後，羅得離開之後，神才開口，把「舉目所見的一切地」給了那個讓的人。讓步的當下沒有掌聲，也沒有立刻的補償，中間有一段甚麼都沒有發生的空白——信心多半就活在那段空白裡。\n\n你現在手上有沒有一塊正在計較的「被拿走的地」？把它說給祂聽。然後試著做亞伯蘭做的那個動作：舉目，從你所在的地方，往東西南北看一看。',
  ...
  },
  {
    ...
    responses:{
      A:'習慣硬撐的人，常常是因為以前開過口、沒被接住。看麥基洗德的做法：他甚麼都沒問，就帶著餅和酒出來——有些接應不需要你先開口。今天練習一小步：下次有人遞東西給你，一杯水、一句慰問，先不要說「不用」，說「謝謝」。',
  ...
  },
  {
    ...
    responses:{
      ...
      D:'連失望是甚麼都還沒整理清楚——那就從不整理開始。神帶亞伯蘭出去看星星的時候，沒有先要求他把問題想清楚。今天不用寫出條列式的禱告，可以只是出去走一圈，仰頭看一次天，跟祂說：我說不清楚，但祢都知道。',
    },
